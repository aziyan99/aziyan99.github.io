+++
title = 'Laravel Adminlte Starter'
date = 2022-03-14T13:14:30Z
draft = false
tags = ['Project', 'CSS']
FeatureCaption = 'Cover Image for Laravel Adminlte Starter'
+++

![GitHub Repo stars](https://img.shields.io/github/stars/aziyan99/laravel-adminlte-starter?style=social) ![GitHub forks](https://img.shields.io/github/forks/aziyan99/laravel-adminlte-starter?style=social) ![GitHub issues](https://img.shields.io/github/issues/aziyan99/laravel-adminlte-starter?style=social)

An starter adminlte dashboard with laravel

<a href="https://github.com/aziyan99/laravel-adminlte-starter" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 10px 20px; margin-top: 15px; margin-bottom: 25px; background-color: #28a745; color: white; text-align: center; text-decoration: none; border-radius: 5px; font-weight: bold;">
